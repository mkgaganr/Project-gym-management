...
<html lang="en">
  ...
  <body>
		...
		<div class="wrapper d-flex align-items-stretch">
            ...
            <li>
               <a href="viewequipment.php">view all equipment</a>
                   </li>
 ...
 $result=mysqli_query($db,$query);
  ...
  echo "<table class='table table-bordered' > ";
          echo "<tr>";
             echo "<th>"; echo "noofsmithmac"; echo "</th>";
             echo "<th>"; echo "noofchestpress"; echo "</th>";
             echo "<th>"; echo "noofsquatrack"; echo "</th>";
             echo "<th>"; echo "noofpecflymac"; echo "</th>";
             echo "<th>"; echo "nooflegpress"; echo "</th>";
...
while($row=mysqli_fetch_array($result))
            {
            	...
            	echo "<tr>";
            	echo "<td>"; echo  $row['noofsmithmac'] ; echo "</td>";
                echo "<td>";  echo $row['noofchestpress'] ; echo "</td>";
                echo "<td>";  echo $row['noofsquatrack'] ; echo "</td>";
            	echo "<td>";  echo $row['noofpecflymac'] ; echo "</td>";
                echo "<td>";  echo $row['nooflegpress'] ; echo "</td>";
            echo "</tr>";
          ...
          <!--   <script type="text/javascript">
              ...
              window.location="/gym/dash/viewequipment.php";
