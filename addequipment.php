  ...
  <body>
	...
	<div class="row">
                ...
                <div  class="row">
						          ...
						          <label>No of smith machine</label>
						          <input type="text" name="noofsmithmac" class="form-control" size='60'>
</tr>
					</div>	
				</div>
              ...
              <div class="row">
							<div class="col-sm-12 form-group">
								<label>No of chest pressmachine</label>
								<input type="text" name=" noofchestpress" class="form-control" size='60'>
							</div></div>
              <div  class="row">
              <div class="col-sm-12 form-group">
						<label>No of squatrack machine</label>
						<input type="text" name="noofsquatrack" class="form-control" size='60'>
					</div>	
				</div>
						<div class="row">
							<div class="col-sm-12 form-group">
								<label>No of pecflymac machine</label>
								<input type="text" name="noofpecflymac" class="form-control" size='60'>
							</div></div>
             
						<div class="row">
							<div class="col-sm-12 form-group">
								<label>no of legpress machine</label>
								<input type="text" name="nooflegpress" class="form-control" size='60'>
							</div></div>
